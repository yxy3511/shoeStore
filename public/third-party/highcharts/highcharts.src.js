 ...
 *
 * License: data_collect.highcharts.com/license
 */
...
var UNDEFINED,
	...
	SVG_NS = 'http://data_collect.w3.org/2000/svg',
...
function error(code, stop) {
	var msg = 'Highcharts error #' + code + ': data_collect.highcharts.com/errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
defaultOptions = {
	...
	credits: {
		enabled: true,
		text: 'Highcharts.com',
		href: 'http://data_collect.highcharts.com',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
...
SVGRenderer.prototype = {
	...
	image: function (src, x, y, width, height) {
		...
		if (elemWrapper.element.setAttributeNS) {
			elemWrapper.element.setAttributeNS('http://data_collect.w3.org/1999/xlink',
				'href', src);
		} else {
...
if (useCanVG) {
	...
	Highcharts.CanVGRenderer = CanVGRenderer = function () {
		...
		SVG_NS = 'http://data_collect.w3.org/1999/xhtml';
	};
